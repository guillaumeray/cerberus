...
type ICodeceptCallback = (i?: CodeceptJS.I, current?:any, footerPage?:CodeceptJS.footerPage, headerPage?:CodeceptJS.headerPage, productPage?:CodeceptJS.productPage, checkoutPage?:CodeceptJS.checkoutPage, cartPage?:CodeceptJS.cartPage, deliveryPage?:CodeceptJS.deliveryPage, tcvarsPage?:CodeceptJS.tcvarsPage, ...args: any) => void;
...
declare function inject(): {
  I: CodeceptJS.I
  footerPage: CodeceptJS.footerPage
  headerPage: CodeceptJS.headerPage
  productPage: CodeceptJS.productPage
  checkoutPage: CodeceptJS.checkoutPage
  cartPage: CodeceptJS.cartPage
  deliveryPage: CodeceptJS.deliveryPage
  tcvarsPage: CodeceptJS.tcvarsPage
};
...
declare namespace CodeceptJS {
  ...
  export interface footerPage {
    checkfooterbar() : void,
    checkfootercontainerurl() : void,
    CheckCorporateSite() : void,
  ...
  export interface headerPage {
    gethomelink() : void,
    Icheckurlhp() : void,
    ISearchAProduct(productname: string) : void,

  }


  export interface productPage {
    IShouldBeOnProductPage() : void,
    IAddTheProductInMyBasket(t: string) : void,
    IShouldHaveAddedTheProduct() : void,
    IGoFromPopinToBasket() : void,

  }


  export interface checkoutPage {
    IShouldHaveItemsInMyCart(item: string) : void,
    IshouldBeOnLoginPage() : void,
    ILogWithUser() : void,
    IShouldBeOnPaymentPage() : void,
    IPayUsingTransfer() : void,
    IShouldBeOnValidationPage() : void,
    IShouldSeeValidationMessage() : void,

  }


  export interface cartPage {
    IShouldBeOnCart() : void,
    IGoToCheckout() : void,
  ...
  export interface deliveryPage {
    IShouldBeOnDelivery() : void,
    IGoToPayment() : void,

  }


  export interface tcvarsPage {
    IcheckTcVarsIsNotEmpty(item: string) : void,
